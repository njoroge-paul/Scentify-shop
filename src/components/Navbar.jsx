...
function Navbar(){
   ...
   return(
    <nav className="bg-white sm:flex flex-grow justify-between items-center shadow-md mr-4 ml-4 lg:p-4 border-2 border-b-[#1FE045] w-auto  " >
    ...
    <ul className="sm:flex flex-grow flex-shrink text-[#1F5AE0] justify-end mr-4 px-8 font-semibold text-xl" >
        ...
        <li className="px-8  rounded-lg  hover:underline text-[#E01FBB] decoration-[#1FE045] underline-offset-4" ><Link to="./Login.jsx" >Login</Link></li>
